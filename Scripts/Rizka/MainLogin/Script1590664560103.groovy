...
WebUI.setText(findTestObject('Rizka/FAQ Management/inputUsername'), 'admin@mail.com')

WebUI.setText(findTestObject('Rizka/FAQ Management/inputPassword'), 'Password1#')
